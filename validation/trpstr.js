...
const trpSTRSchema = Joi.object({
    ...
    //     .default("auto"),
    period_qcstrA: Joi.number().integer().allow("").optional(),
    refbias_binsize_qcstrA: Joi.number().integer().allow("").optional(),
    refbias_metric_qcstrA: Joi.string()
        .valid("mean", "medium")
        .default("mean"),
    refbias_mingts_qcstrA: Joi.number().integer().allow("").optional(),
    refbias_xrange_min_qcstrA: Joi.number().integer().allow("").optional(),
    refbias_xrange_max_qcstrA: Joi.number().integer().allow("").optional(),
    ...
    //     .valid("gangstr", "advntr", "hipstr", "auto", "popstr", "eh")
    //     .default("auto"),
    period_qcstrB: Joi.number().integer().allow("").optional(),
    refbias_binsize_qcstrB: Joi.number().integer().allow("").optional(),
    refbias_metric_qcstrB: Joi.string()
        .valid("mean", "medium")
        .default("mean"),
    refbias_mingts_qcstrB: Joi.number().integer().allow("").optional(),
    refbias_xrange_min_qcstrB: Joi.number().integer().allow("").optional(),
    refbias_xrange_max_qcstrB: Joi.number().integer().allow("").optional(),
