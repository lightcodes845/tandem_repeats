...
function getJobParameters(parameters) {
  return [
    ...
    String(parameters.num_records),
    String(parameters.min_locus_rate),
    String(parameters.min_locus_hwep),
    String(parameters.min_locus_het),
    String(parameters.max_locus_het),
    String(parameters.filter_regions),
    String(parameters.filter_regions_names),
    String(parameters.hipstr_max_call_flank_indel),
    String(parameters.hipstr_max_call_stutter),
    String(parameters.hipstr_min_supp_reads),
    String(parameters.hipstr_min_call_DP),
    String(parameters.hipstr_max_call_DP),
    String(parameters.hipstr_min_call_Q),
    String(parameters.gangstr_min_call_DPl),
    String(parameters.gangstr_max_call_D),
    String(parameters.gangstr_min_call_Q),
    String(parameters.gangstr_expansion_prob_het),
    String(parameters.gangstr_expansion_prob_hom),
    String(parameters.gangstr_expansion_prob_total),
    String(parameters.advntr_min_call_DP),
    String(parameters.advntr_max_call_DP),
    String(parameters.advntr_min_spanning),
    String(parameters.advntr_min_flanking),
    String(parameters.advntr_min_ML),
    String(parameters.eh_min_call_LC),
    String(parameters.eh_max_call_LC),
    String(parameters.popstr_min_call_DP),
    String(parameters.popstr_max_call_DP),
    String(parameters.popstr_require_support),
  ];
}
