...
const { createJob } = require("../services/statstr");
const queue = require("../queues/statstr.queue");

// @desc create new StatSTR job
// @route POST /api/v1/statstr/jobs
// @access Private
...
// @desc create new StatSTR job
// @route POST /api/v1/statstr/noauth/jobs
// @access Public
...
// @desc get single job
// @route GET /api/v1/statstr/jobs/:id
// @access Private
exports.getJob = asyncHandler(async (req, res, next) => {
    const job = await StatSTRJob.findById(id)
        .populate("statstr")
        .populate("user");
...
// @route GET /api/v1/statstr/noauth/jobs/:id
// @access Public
...
// @desc delete job
// @route DELETE /api/v1/statstr/jobs/:id
// @access Private
exports.deleteJob = asyncHandler(async (req, res, next) => {
    const job = await StatSTRJob.findById(req.params.id);
