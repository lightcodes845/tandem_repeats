...
const { createJob } = require("../services/gangstr");
const queue = require("../queues/gangstr.queue");

// @desc create new GangSTR job
// @route POST /api/v1/gangstr/jobs
// @access Private
...
// @desc create new GangSTR job
// @route POST /api/v1/gangstr/noauth/jobs
// @access Public
...
// @desc get single job
// @route GET /api/v1/gangstr/jobs/:id
// @access Private
exports.getJob = asyncHandler(async (req, res, next) => {
    const job = await GangSTRJob.findById(id)
        .populate("gangstr")
        .populate("user");
...
// @route GET /api/v1/gangstr/noauth/jobs/:id
// @access Public
...
// @desc delete job
// @route DELETE /api/v1/gangstr/jobs/:id
// @access Private
exports.deleteJob = asyncHandler(async (req, res, next) => {
    const job = await GangSTRJob.findById(req.params.id);
