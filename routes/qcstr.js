...
const {
    ...
    getJobNoAuth,
    deleteJob,
} = require("../controllers/qcstr");
const validate = require("../middlewares/validation");
const jobResults = require("../middlewares/job_results");
const { protect } = require("../middlewares/auths");
const { qcSTRSchema } = require("../validation/qcstr");

const router = express.Router();

router.post("/noauth/jobs", validate(qcSTRSchema), createJobNoAuth);
router.post("/jobs", protect, validate(qcSTRSchema), createJob);
